...
{
	echo "<div class=\"dcm-home-testimonials-rating\">\n";
	for($r=1; $r <= $rating; $r++)
	{
...
if( $show_title )
{
	echo "<{$title_heading} class=\"dcm-home-testimonials-title\">";
...
// DESCRIPTION
echo "<div class=\"text dcm-home-testimonials-description\">\n";

// CONTENT
if( $show_body )
{
	echo "<div class=\"dcm-home-testimonials-quote\">\n";
...
if( $cite AND $show_author )
{
	...
	echo "<div class=\"dcm-home-testimonials-author cf-tr\">\n";
	echo wpautop($cite);
	echo "</div>\n";
}
